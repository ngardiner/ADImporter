# Note
This is far from the most advanced version of this script, however I needed a version which focused on volume, with a little less focus on randomization of values such as Male/Female names or Addresses.
...
* Credit to RobBridgeman for his collation of resources to make generating AD accounts for lab testing easy - https://github.com/RobBridgeman/ADImporter
...
The purpose of the script is to create an arbitrary number of user accounts.
